...
input_files = [
    ...
    # '/Users/Pharrell_WANG/PycharmProjects/vcmd_data_prepare/5_concatenating_all_32x32/32x32_merged.csv'
]
...
output_files = [
    ...
    # '/Users/Pharrell_WANG/PycharmProjects/vcmd_data_prepare/5_concatenating_all_32x32/32x32_merged_3536.csv'
]
...
for file_index in range(len(input_files)):
    ...
    for x in range(number_of_rows):
        ...
        if df[1025][x] == 37:
            cnt_37 += 1
            print('got one for 37 to 35: ' + str(x+1))
            df[1025][x] = 35
        if df[1025][x] == 38:
            cnt_38 += 1
            print('got one for 38 to 36: ' + str(x+1))
            df[1025][x] = 36
    print('')
    print('=======================')
